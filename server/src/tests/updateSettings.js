...
export const updateSettingsTests = () => {
  ...
  it("should not allow updating if game is in progress", async () => {
  ...
  it("should update settings when not in a game", async () => {
  ...
  it("should update settings in post game lobby", async () => {
